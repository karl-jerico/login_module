        ...
        <div class="card">
            <div class="flex items-center justify-between p-4 bg-white border-b-2 rounded-xl w-full ">
                ...
                <a href="{{ route('roles.create') }}"
                    class=" float-end text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  focus:outline-none ">Add
                    User</a>
            </div>
            <div class="card-body">
